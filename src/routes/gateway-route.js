...
const { AUTH_SERVICE_URL, PRODUCT_SERVICE_URL, CART_SERVICE_URL, PAYMENT_SERVICE_URL, ORDER_SERVICE_URL } = require('../config/serverConfig');
...
router.use('/products', Authentication, (req, res) =>
    gatewayController.routeRequest(req, res, PRODUCT_SERVICE_URL)
);
